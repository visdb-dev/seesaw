...
public class AbstractComboBoxListSwingModelEventTest {
  ...
  public void setUp() {
    ...
    LocalDate[] d
        = new LocalDate[] {d1, d1.plusDays(1), d1.plusDays(2), d1.plusDays(3), d1.plusDays(4)};
    LocalDateTime[] dt = new LocalDateTime[] {dt1, dt1.plusHours(1), dt1.plusHours(2),
                                              dt1.plusHours(3), dt1.plusHours(4)};
    ...
    l3.addAll(Arrays.asList(new Date[] {Date.valueOf(d[0]), Date.valueOf(d[1]), Date.valueOf(d[2]),
                                        Date.valueOf(d[3]), Date.valueOf(d[4])}));
    l4.addAll(Arrays.asList(new Timestamp[] {Timestamp.valueOf(dt[0]), Timestamp.valueOf(dt[1]),
                                             Timestamp.valueOf(dt[2]), Timestamp.valueOf(dt[3]),
  ...
  public void testGetElementAt(LI li) {
    ...
    if (li.isComboBoxModel()) {
      ...
      assertThrows(IndexOutOfBoundsException.class, () -> li.proxy.getElementAt(0));
    }
