...
public class ZoomCanvas extends JPanel {
    ...
    public Point translate(
        ...
        double offsetXInImageSpace = (panelWidth > screenImageWidth)
				? ((panelWidth - screenImageWidth) / 2.0) / currentZoom : 0.0;
        double offsetYInImageSpace = (panelHeight > screenImageHeight)
				? ((panelHeight - screenImageHeight) / 2.0) / currentZoom : 0.0;
        ...
        CoordSystem activeToSystem = (toCoordSystem == CoordSystem.VIEWPORT)
				? CoordSystem.CANVAS : toCoordSystem;
